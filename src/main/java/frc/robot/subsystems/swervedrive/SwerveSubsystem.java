...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
    ...
    /**
     * Returns a Command that drives the swerve drive to a specific distance at
     * a given speed.
     *
     * @param distanceInMeters the distance to drive in meters
     * @param speedInMetersPerSecond the speed at which to drive in meters per
     * second
     * @return a Command that drives the swerve drive to a specific distance at
     * a given speed
     */
    ...
    /**
     * Command to drive the robot using translative values and heading as
     * angular velocity.
     *
     ...
     * module states accordingly. Can use either open-loop or closed-loop
     * velocity control for the wheel velocities. Also has field- and
     * robot-relative modes, which affect how the translation vector is used.
     *
     * @param translation {@link Translation2d} that is the commanded linear
     * velocity of the robot, in meters per second. In robot-relative mode,
     * positive x is torwards the bow (front) and positive y is torwards port
     * (left). In field-relative mode, positive x is away from the alliance wall
    ...
    /**
     * Gets the current pose (position and rotation) of the robot, as reported
     * by odometry.
     *
    ...
    /**
     * Resets the gyro angle to zero and resets odometry to the same position,
     * but facing toward 0.
     */
     ...
     * available.
     *
     * @return true if the red alliance, false if blue. Defaults to false if
     * none is available.
     */
