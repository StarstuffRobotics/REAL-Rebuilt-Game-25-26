...
public final class Constants {
  ...
  public static final class Swerve {
    ...
    public static final double FL_OFFSET = 0; // change them back, do a better job and make sure they are right
    ...
    public static final double BL_OFFSET = 0;// change them back, do a better job and make sure they are right
    ...
    public static final double STEER_GEAR_RATIO = 6.75;
