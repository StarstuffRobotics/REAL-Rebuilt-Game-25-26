...
public static final double SLOW_ROTATION_FACTOR = 0.6; // 60% of max rotation
        ...
        public static final double FL_OFFSET = 0.065; // TODO: Align wheels and update these
        ...
        // --- MAXSwerve Physical Constants ---
        public static final double WHEEL_DIAMETER = Units.inchesToMeters(3.0);
        public static final double STEER_GEAR_RATIO = 9.42; 
        public static final double DRIVE_GEAR_RATIO = 4.71; // Standard L2 Gear Ratio

        // Conversion: Rotations to Meters/Radians
        ...
        public static final double angleP = 1.0; // MAXSwerve usually needs a higher P than 0.5
